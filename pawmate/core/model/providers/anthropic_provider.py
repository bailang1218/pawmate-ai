...
from pawmate.core.model.provider_contract import tool_use_event
            ...
            async for event in stream:
                ...
                if event.type == "content_block_start":
                    ...
                    if current_tool_use is not None:
                        ...
                        try:
                            parsed_input = json.loads(full_input_json)
                        except json.JSONDecodeError:
                            parsed_input = {"raw": full_input_json}

                        yield tool_use_event(
                            current_tool_use.get("id"),
                            current_tool_use.get("name"),
                            parsed_input,
                            raw_arguments=full_input_json,
                            provider="anthropic",
                        )
